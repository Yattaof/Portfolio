...
function ChampionsLeague() {
	...
	const { selectedDayAPI, currentTime, currentDayAPI } = dateContext!;

	const league = 'UEFA_Champions_League';
		...
		<>
			<div className={styles.leagueName}>
				<div className={styles.leagueInfo}>
					<img src='/images/championsLeague.png' alt='Logo Champions League' />
